			...
			<div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-4">
				<div className="grid mb-8 lg:grid-cols-6">
					...
					<div className="md:max-w-md lg:col-span-2 lg:mt-0 mt-5">
						...
						<form action="submit" className="mt-4 flex flex-col md:flex-row">
						...
						<p className="mt-4 text-sm text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet, fuga, officia rem iure quasi non reiciendis perspiciatis dolore maiores, eaque aliquam. Vel, sint explicabo quam ipsum obcaecati illum aut provident!</p>
					</div>
				</div>

				<div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
				<p className="text-sm text-gray-500">&copy; Copyright 2024 | All rights are reserved</p>
